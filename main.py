...
def extract_fields_from_schema(schema, components, parent_name=''):
    ...
    if 'properties' in schema:
        ...
        for property_name, attributes in schema['properties'].items():
            ...
            if temp_type not in ('object') or (temp_type == 'array' and 'properties' not in attributes): # and array properties not exist?
...
# TODO
# bug with an object in an array - actually not

# omit non data objects and arrays
